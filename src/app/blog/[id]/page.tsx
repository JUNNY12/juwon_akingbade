...
export default async function BlogPage({ params: { id } }: Params) {
  ...
  return (
    <SinglePostWrapper >
      ...
      <div className="mt-3">
        <Typography variant={1} className="text-3xl font-bold mb-2">Related Tags</Typography>

        <p className=" flex flex-wrap">
          {
            tags.map((tag: string, i) => {
              return <Link className="me-3 mb-3 bg-gray-200  hover:bg-gray-300 p-1 rounded text-black font-[550]
      ...
      <div className="mt-6">
        <Link className="bg-gray-400  hover:bg-gray-600 p-[0.5rem] rounded text-black font-[550]
